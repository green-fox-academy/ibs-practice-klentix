...
print ('Blog post 1: ' + '\n Author Name: ' + post1.authorName
       + '\n Title:  ' + post1.title
       + '\n Text: ' + post1.text
       + '\n Publication Date: ' + post1.publicationDate )
...
print ('Blog post 2: ' + '\n Author Name: ' + post2.authorName
       + '\n Title:  ' + post2.title
       + '\n Text: ' + post2.text
       + '\n Publication Date: ' + post2.publicationDate )
...
print ('Blog post 3: ' + '\n Author Name: ' + post3.authorName
       + '\n Title:  ' + post3.title
       + '\n Text: ' + post3.text
       + '\n Publication Date: ' + post3.publicationDate )
